...
- (id)initWithCoordinate:(CLLocationCoordinate2D)theCoordinate frame:(CGRect)frame
{
    ...
    if (self) {
		...
		[anArtistLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.25f]];
...
- (void)setArt:(Art *)art
{
	...
	[self.summaryLabel setFrame:CGRectMake(self.artistLabel.frame.origin.x, yOffset, self.titleLabel.frame.size.width, 60.0f)];
