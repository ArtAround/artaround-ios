...
@synthesize webView = _webView, mapView = _mapView, photosScrollView = _photosScrollView, submitButton = _submitButton, bottomToolbar = _bottomToolbar;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [aWebView.scrollView setContentInset:UIEdgeInsetsMake(0.0f, 0.0f, _kSubmitButtonBarHeight, 0.0f)];
        [aWebView.scrollView setScrollIndicatorInsets:UIEdgeInsetsMake(0.0f, 0.0f, _kSubmitButtonBarHeight, 0.0f)];        
